...
if (isset($_POST['place_order'])) {
    ...
    $email = $_POST['email'];
    $email = filter_id($email, FILTER_SANITIZE_STRING);
    $address = $_POST['flat'] . ', ' . $_POST['city'] . ', ' . $_POST['country'] . ', ' . $_POST['pincode'];
        ...
        <section class="checkout">
            ...
            <section class="checkout">
                <div class="title">
                    <img src="" class="logo">
                    <h1>checkout summary</h1>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Illo veniam beatae, perspiciatis consequatur eligendi molestiae assumenda doloribus alias maxime quia unde! Consectetur eaque dolore, unde porro inventore vel provident consequatur.</p>
                </div>
                <div class="row">
                    <form method="post">
                        ...
                        <div class="flex">
                            ...
                            <div class="box">
                                <div class="input-field">
                                    ...
                                    <input type="text" name="flat" require maxlength="50" placeholder="e.g flat & building number" class="input">
                                </div>
                                <div class="input-field">
                                ...
                                <div class="input-field">
                                    ...
                                    <input type="text" name="county" require maxlength="50" placeholder="Enter your city name" class="input">
                                </div>
                                <div class="input-field">
                                    <p>pincode <span>*</span></p>
                                    <input type="text" name="pincode" require maxlength="50" placeholder="110022" min="0" max="999999" class="input">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="summary">
                        ...
                        <div class="grand-total">total amount payable: <span>$<?= $grand_total ?>/-</span></div>
                    </div>
