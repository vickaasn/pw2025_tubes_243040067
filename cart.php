...
if (isset($_POST['delete_item'])) {
    ...
    if ($varify_delete_items->rowCount() > 0) {
        $delete_wishlist_id = $conn->prepare("DELETE FROM 'cart' WHERE id = ?");
                ...
                ?>
                            <form method="post" action="" class="box">
                                ...
                                <div class="flex">
                                    ...
                                    <input type="number" name="qty" require min="1" value="<?= $fetch_cart['qty']; ?>" max="99" maxlength="2" class="qty">
            ...
            ?>
                <div class="cart-total">
                    ...
                    <div class="button">
                        ...
                        <a href="checkout.php" class="btn">proced to checkout</a>
                    </div>
                </div>
            <?php } ?>
